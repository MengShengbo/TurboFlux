...
- Dataset cases: 10; repositories: 8; languages: Python
- Repository snapshots processed: 0.02M files, 0.20 GiB (counts include repeated base commits)
- Per-run timeout: 300s; repeats: 1; seed: 20260722
- Manifest SHA-256: `c873385346260ec748cc06d61159d067ecbad219c3e9985a0859323ffdc7e149`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 10 / 10 | 100.0% | 0.900 [0.700, 1.000] | 0.783 [0.550, 1.000] | 0.783 | 0.813 | 90.0% | 77.3s / 117.6s | 10.5 | 21072 / 1606 |
...
|---|---|---:|---:|---:|---:|---:|
| Python | fastcontext | 10 | 100.0% | 0.900 | 0.783 | 77.3s |
