...
- Dataset cases: 10; repositories: 8; languages: Java, JavaScript, Python
- Repository snapshots processed: 0.02M files, 0.81 GiB (counts include repeated base commits)
- Per-run timeout: 600s; repeats: 1; seed: 20260722
- Manifest SHA-256: `5716f784e7b192867daf470ba21775d7362d0a5b64ae6a2b3cfa07dd32ec426d`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 10 / 10 | 100.0% | 0.950 [0.850, 1.000] | 1.000 [1.000, 1.000] | 0.950 | 0.961 | 90.0% | 55.2s / 110.8s | 9.5 | 40021 / 1614 |
| claude-code-readonly | 10 / 10 | 100.0% | 0.900 [0.700, 1.000] | 0.900 [0.700, 1.000] | 0.883 | 0.892 | 90.0% | 37.1s / 219.2s | 8.4 | 33744 / 1415 |
| opencode-explore | 10 / 10 | 100.0% | 1.000 [1.000, 1.000] | 1.000 [1.000, 1.000] | 1.000 | 1.000 | 100.0% | 203.6s / 350.3s | 9.7 | 48314 / 1516 |
...
| System | Tasks / runs | Success | R@10 (95% CI) | MRR (95% CI) | MAP | nDCG@10 | Full@10 | p50 / p95 | Tools | Tokens in/out |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 5 / 5 | 100.0% | 0.900 [0.700, 1.000] | 1.000 [1.000, 1.000] | 0.900 | 0.923 | 80.0% | 48.6s / 70.3s | 8.6 | 18566 / 1089 |
| claude-code-readonly | 5 / 5 | 100.0% | 1.000 [1.000, 1.000] | 1.000 [1.000, 1.000] | 0.967 | 0.984 | 100.0% | 37.1s / 110.4s | 6.0 | 23627 / 1124 |
| opencode-explore | 5 / 5 | 100.0% | 1.000 [1.000, 1.000] | 1.000 [1.000, 1.000] | 1.000 | 1.000 | 100.0% | 91.1s / 244.0s | 10.6 | 54553 / 1600 |

### swepolybench-verified

| System | Tasks / runs | Success | R@10 (95% CI) | MRR (95% CI) | MAP | nDCG@10 | Full@10 | p50 / p95 | Tools | Tokens in/out |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 5 / 5 | 100.0% | 1.000 [1.000, 1.000] | 1.000 [1.000, 1.000] | 1.000 | 1.000 | 100.0% | 93.1s / 110.8s | 10.4 | 61475 / 2139 |
| claude-code-readonly | 5 / 5 | 100.0% | 0.800 [0.400, 1.000] | 0.800 [0.400, 1.000] | 0.800 | 0.800 | 80.0% | 48.5s / 219.2s | 10.8 | 43860 / 1706 |
| opencode-explore | 5 / 5 | 100.0% | 1.000 [1.000, 1.000] | 1.000 [1.000, 1.000] | 1.000 | 1.000 | 100.0% | 245.2s / 350.3s | 8.8 | 42075 / 1431 |

## Language Slices

| Language | System | N | Success | R@10 | MRR | p50 |
|---|---|---:|---:|---:|---:|---:|
| Java | fastcontext | 1 | 100.0% | 1.000 | 1.000 | 110.1s |
| Java | claude-code-readonly | 1 | 100.0% | 1.000 | 1.000 | 48.5s |
| Java | opencode-explore | 1 | 100.0% | 1.000 | 1.000 | 245.2s |
| JavaScript | fastcontext | 1 | 100.0% | 1.000 | 1.000 | 84.3s |
| JavaScript | claude-code-readonly | 1 | 100.0% | 1.000 | 1.000 | 25.6s |
| JavaScript | opencode-explore | 1 | 100.0% | 1.000 | 1.000 | 218.1s |
| Python | fastcontext | 8 | 100.0% | 0.938 | 1.000 | 48.6s |
| Python | claude-code-readonly | 8 | 100.0% | 0.875 | 0.875 | 37.1s |
| Python | opencode-explore | 8 | 100.0% | 1.000 | 1.000 | 123.0s |

## Paired Tests

| FastContext system | Comparator | Pairs | Mean R@10 difference | Paired permutation p |
|---|---|---:|---:|---:|
| fastcontext | claude-code-readonly | 10 | 0.050 | 1.0000 |
| fastcontext | opencode-explore | 10 | -0.050 | 1.0000 |
