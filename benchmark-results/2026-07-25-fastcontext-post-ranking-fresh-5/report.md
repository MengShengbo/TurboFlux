...
- Completed runs: 5/5
- Dataset cases: 5; repositories: 5; languages: Java, Python
- Repository snapshots processed: 0.01M files, 0.13 GiB (counts include repeated base commits)
- Per-run timeout: 300s; repeats: 1; seed: 20260722
- Manifest SHA-256: `7dc26553a58ba2d6d288cace0c1c39247935bfbf5e32bbcc60d3c0544a38849e`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 5 / 5 | 80.0% | 0.733 [0.333, 1.000] | 0.800 [0.400, 1.000] | 0.733 | 0.753 | 60.0% | 38.7s / 73.0s | 6.8 | 10413 / 1497 |
...
| System | Tasks / runs | Success | R@10 (95% CI) | MRR (95% CI) | MAP | nDCG@10 | Full@10 | p50 / p95 | Tools | Tokens in/out |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 2 / 2 | 50.0% | 0.500 [0.000, 1.000] | 0.500 [0.000, 1.000] | 0.500 | 0.500 | 50.0% | 66.5s / 66.5s | 7.0 | 16878 / 1917 |

### swebench-verified

| System | Tasks / runs | Success | R@10 (95% CI) | MRR (95% CI) | MAP | nDCG@10 | Full@10 | p50 / p95 | Tools | Tokens in/out |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 3 / 3 | 100.0% | 0.889 [0.667, 1.000] | 1.000 [1.000, 1.000] | 0.889 | 0.922 | 66.7% | 38.7s / 73.0s | 6.7 | 8258 / 1357 |

## Language Slices

| Language | System | N | Success | R@10 | MRR | p50 |
|---|---|---:|---:|---:|---:|---:|
| Java | fastcontext | 1 | 0.0% | 0.000 | 0.000 | 0.0s |
| Python | fastcontext | 4 | 100.0% | 0.917 | 1.000 | 38.7s |
...
|---|---:|---|
| fastcontext:protocol | 1 | apache__dubbo-5783: All compatible model protocols failed:
1. OpenAI Responses https://api.aibinghe.xyz/v1/responses — HTTP 503: {"error":{"message":"Service temporarily unavailabl |
