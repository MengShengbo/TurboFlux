...
- Completed runs: 3/3
- Dataset cases: 3; repositories: 3; languages: Java, Python, TypeScript
- Repository snapshots processed: 0.05M files, 0.24 GiB (counts include repeated base commits)
- Per-run timeout: 600s; repeats: 1; seed: 20260722
- Manifest SHA-256: `477f6a2f4dd83490f1707831761e06afdfa412d6bfd6a8f355d0db1998e068f6`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 3 / 3 | 100.0% | 0.667 [0.333, 1.000] | 1.000 [1.000, 1.000] | 0.630 | 0.725 | 33.3% | 115.5s / 124.1s | 17.3 | 54538 / 2721 |
...
|---|---|---:|---:|---:|---:|---:|
| Java | fastcontext | 1 | 100.0% | 0.333 | 1.000 | 115.5s |
| Python | fastcontext | 1 | 100.0% | 0.667 | 1.000 | 79.7s |
| TypeScript | fastcontext | 1 | 100.0% | 1.000 | 1.000 | 124.1s |
