...
import type { SubAgentDefinition, SubAgentThinking } from '@turboflux/contracts/subAgentTypes'
...
function mapToDefinition(
  ...
  return {
    ...
    thinking: (meta.thinking && VALID_THINKING.has(meta.thinking)) ? meta.thinking : 'disabled',
    source,
    filePath,
    color: meta.color,
    skills: meta.skills,
