export interface SkillPromptTarget {
  setAppendSystemPrompt(prompt: string | undefined): void
}
...
export class SkillRuntime {
  ...
  constructor(private workspacePath: string, private userSkillsRoot?: string) {
    this.reload()
  }

  reload(): void {
    this.skills = loadAllSkills(this.workspacePath, this.userSkillsRoot)
  }
  ...
  activate(skillId: string, engine: SkillPromptTarget): boolean {
  ...
  deactivate(engine: SkillPromptTarget): void {
