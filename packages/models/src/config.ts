...
} from '@turboflux/platform/fileIO'
import { getActiveProfilePaths } from '@turboflux/platform/profilePaths'

import type { TurboFluxConfig, ModelPreset, ModelMetadataSource, ModelCapabilities, TurboFluxProvider, TurboFluxConfigKey, TurboFluxApiConfigProfile, ProviderPreset } from '@turboflux/contracts/modelConfigTypes'
export type { TurboFluxConfig, ModelPreset, ModelMetadataSource, ModelCapabilities, TurboFluxProvider, TurboFluxConfigKey, TurboFluxApiConfigProfile, ProviderPreset } from '@turboflux/contracts/modelConfigTypes'
...
export function getConversationsDir(): string {
  return getActiveProfilePaths().conversationsRoot
}
