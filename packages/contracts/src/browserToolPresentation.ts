...
const BROWSER_TOOLS: Record<string, BrowserToolDefinition> = {
  capabilities: { title: '检查浏览器能力', running: '正在检查浏览器支持范围', completed: '已检查浏览器支持范围', needsApproval: false },
  mark_deliverable: { title: '保留结果页面', running: '正在保留结果页面', completed: '结果页面已保留', needsApproval: false },
  mark_handoff: { title: '保留接续页面', running: '正在保留接续页面', completed: '接续页面已保留', needsApproval: false },
  ...
  inspect: { title: '审查页面状态', running: '正在检查布局与控件状态', completed: '已检查布局与控件状态', needsApproval: false },
  ...
  set_layout: { title: '调整浏览器布局', running: '正在调整浏览器布局', completed: '浏览器布局已调整', needsApproval: false },
