export const EN_MESSAGES = {
  ...
  'ui.landing.flowReady': 'Flow v2 ready · recoverable input · /flow status',
  'ui.landing.flowFallback': 'Flow core active · compact UI · /flow status',
...
export const ZH_CN_MESSAGES = {
  ...
  'ui.landing.flowReady': 'Flow v2 已就绪 · 输入可恢复 · /flow status',
  'ui.landing.flowFallback': 'Flow 核心已启用 · 精简 UI · /flow status',
