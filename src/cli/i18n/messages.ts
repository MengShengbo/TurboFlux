export const EN_MESSAGES = {
  ...
  'setup.current.fastContextFollowMain': 'follows main model',
  ...
  'setup.current.fastContextModel': 'FastContext model',
  ...
  'setup.fastContext.followMain': 'FastContext always follows the active main model.',
  ...
  'setup.approval.full': 'Skip approval prompts - explicit deny rules remain active',
  ...
  'setup.reset.confirm': 'Reset local TurboFlux configuration? API keys, model profiles, personas, and language will return to defaults.',
  'setup.reset.done': 'Configuration reset.',
  'setup.menu.title': 'Select action',
  'setup.menu.init': '1. Full initialization - language + API + FastContext + persona + custom instructions',
  ...
  'ui.diff.apply': 'Apply this change?',
  'ui.diff.yes': '[y]es',
  'ui.diff.no': '[n]o',
  'ui.diff.accepted': 'Change accepted.',
  'ui.diff.rejected': 'Change rejected.',
  'ui.diff.label': 'diff: {filename}',
  ...
  'ui.fastContext.handoff': 'Evidence handed to MAIN AGENT',
  'ui.fastContext.ready': '{files} files / {ranges} ranges ready',
  'ui.fastContext.cancelled': 'FastContext stopped before handoff',
  'ui.fastContext.failed': 'FastContext failed before handoff',
  'ui.fastContext.currentTarget': 'CURRENT TARGET',
  'ui.fastContext.flowTrace': 'FLOW TRACE',
  'ui.fastContext.wave': 'wave {wave}/{maxWaves}',
  'ui.fastContext.counts': '{files} files - {hits} hits',
  'ui.fastContext.mapping': 'mapping code...',
  'ui.fastContext.captured': 'Captured {files} evidence files across {ranges} line ranges',
  'ui.fastContext.title': 'FASTCONTEXT ONLINE',
  'ui.fastContext.stage.map': 'MAP',
  'ui.fastContext.stage.read': 'READ',
  'ui.fastContext.stage.rank': 'RANK',
  'ui.fastContext.stage.synth': 'SYNTH',
  'ui.fastContext.phase.mapping': 'MAPPING',
  'ui.fastContext.phase.reading': 'READING',
  'ui.fastContext.phase.scanning': 'SCANNING',
  'ui.fastContext.phase.ranking': 'RANKING',
  'ui.fastContext.phase.synthesizing': 'SYNTHESIZING',
  'ui.fastContext.phase.completed': 'COMPLETE',
  'ui.fastContext.phase.cancelled': 'CANCELLED',
  'ui.fastContext.phase.error': 'ERROR',
  'ui.fastContext.metrics': 'WAVE {wave}  {files}F  {absorbed}E  {hits}H',
  'ui.fastContext.trace.phase': 'PHASE',
  'ui.fastContext.trace.worker': 'WORKER',
  'ui.fastContext.trace.discovered': 'TRACE',
  'ui.fastContext.trace.read': 'READ',
  'ui.fastContext.trace.absorbed': 'ABSORB',
  'ui.fastContext.trace.error': 'ERROR',
  'ui.fastContext.trace.skipped': 'SKIP',
  'ui.fastContext.trace.evidence': 'EVIDENCE',
  'ui.fastContext.trace.progress': 'PROGRESS',
  'ui.fastContext.trace.turn': 'TURN {turn}',
  'ui.fastContext.trace.progressDetail': '{absorbed}/{files} absorbed - {hits} hits{latest}',
  'ui.fastContext.trace.turnDetail': '{calls} calls - {duration} - {tokens} out',
  'ui.work.label': 'Work',
  'ui.work.mainAgent': 'MAIN AGENT',
  'ui.activity.title': 'Activity',
  'ui.activity.summaryWorking': '{count} working',
  'ui.activity.summaryComplete': '{count} complete',
  'ui.activity.summaryFailed': '{count} failed',
  ...
  'ui.flow.fastContextState': 'FastContext is {state}',
  'ui.flow.readyNext': 'Ready for the next task',
  'ui.flow.fcEvidence': 'FC {state} · {count} evidence',
  'ui.flow.fcState': 'FC {state}',
  'ui.flow.fcEvidenceReady': 'FC evidence ready',
  'ui.flow.fcFailed': 'FC failed',
  'ui.flow.fcCancelled': 'FC cancelled',
  ...
  'ui.flow.fcAssembling': 'assembling',
  'ui.flow.fcRanking': 'ranking',
  'ui.flow.fcMapping': 'mapping',
  'ui.flow.fcReady': 'ready',
  'ui.flow.fcCancelledState': 'cancelled',
  'ui.flow.fcAttention': 'needs attention',
  ...
  'ui.file.label': 'File',
  'ui.file.writing': 'Writing',
  'ui.file.replacing': 'Replacing',
  'ui.file.editing': 'Editing',
  'ui.file.applying': 'Applying edits to',
  'ui.file.deleting': 'Deleting',
  'ui.file.preparingWrite': 'Preparing write for',
  'ui.file.preparingReplace': 'Preparing replacement for',
  'ui.file.preparingEdit': 'Preparing edit for',
  'ui.file.preparingEdits': 'Preparing edits for',
  'ui.file.preparingDelete': 'Preparing delete for',
  'ui.file.target': '{verb} file',
  'ui.file.prepared': ' - {size} prepared',
  ...
  'ui.tool.explore': 'Explore "{target}"',
  ...
  'ui.tool.running.explore': 'Exploring {target}',
  ...
  'ui.tool.name.exploreCode': 'Explore code',
  ...
  'command.approval.full': 'Skip approval prompts',
...
export const ZH_CN_MESSAGES = {
  ...
  'setup.current.fastContextFollowMain': '跟随主模型',
  ...
  'setup.current.fastContextModel': 'FastContext 模型',
  ...
  'setup.fastContext.followMain': 'FastContext 始终跟随当前主模型。',
  ...
  'setup.approval.full': '跳过审批提示 - 明确拒绝规则仍然生效',
  'setup.approval.saved': '审批策略：{policy}',
  'setup.init.editInstructions': '现在编辑全局自定义指令？',
  'setup.init.done': '完成。现在可以运行：turboflux <workspace>',
  'setup.reset.confirm': '确认重置本机 TurboFlux 配置？API Key、模型配置、人设和语言都会恢复默认。',
  'setup.reset.done': '已重置配置。',
  'setup.menu.title': '选择功能',
  'setup.menu.init': '1. 完整初始化 - 语言 + API + FastContext + 人设 + 自定义指令',
  ...
  'ui.diff.yes': '[y]是',
  'ui.diff.no': '[n]否',
  'ui.diff.accepted': '已接受变更。',
  'ui.diff.rejected': '已拒绝变更。',
  'ui.diff.label': 'diff：{filename}',
  'ui.diff.created': '已创建',
  'ui.diff.deleted': '已删除',
  ...
  'ui.fastContext.handoff': '证据已交给主 Agent',
  'ui.fastContext.ready': '{files} 个文件 / {ranges} 个范围已就绪',
  'ui.fastContext.cancelled': 'FastContext 在交接前已停止',
  'ui.fastContext.failed': 'FastContext 在交接前失败',
  'ui.fastContext.currentTarget': '当前目标',
  'ui.fastContext.flowTrace': '流程轨迹',
  'ui.fastContext.wave': '波次 {wave}/{maxWaves}',
  'ui.fastContext.counts': '{files} 个文件 - {hits} 个命中',
  'ui.fastContext.mapping': '正在绘制代码结构…',
  'ui.fastContext.captured': '已从 {ranges} 个代码范围捕获 {files} 个证据文件',
  'ui.fastContext.title': 'FASTCONTEXT 已启动',
  'ui.fastContext.stage.map': '映射',
  'ui.fastContext.stage.read': '读取',
  'ui.fastContext.stage.rank': '排序',
  'ui.fastContext.stage.synth': '汇总',
  'ui.fastContext.phase.mapping': '正在映射',
  'ui.fastContext.phase.reading': '正在读取',
  'ui.fastContext.phase.scanning': '正在扫描',
  'ui.fastContext.phase.ranking': '正在排序',
  'ui.fastContext.phase.synthesizing': '正在汇总',
  'ui.fastContext.phase.completed': '已完成',
  'ui.fastContext.phase.cancelled': '已取消',
  'ui.fastContext.phase.error': '出错',
  'ui.fastContext.metrics': '波次 {wave}  {files} 文件  {absorbed} 证据  {hits} 命中',
  'ui.fastContext.trace.phase': '阶段',
  'ui.fastContext.trace.worker': '工作单元',
  'ui.fastContext.trace.discovered': '发现',
  'ui.fastContext.trace.read': '读取',
  'ui.fastContext.trace.absorbed': '吸收',
  'ui.fastContext.trace.error': '错误',
  'ui.fastContext.trace.skipped': '跳过',
  'ui.fastContext.trace.evidence': '证据',
  'ui.fastContext.trace.progress': '进度',
  'ui.fastContext.trace.turn': '轮次 {turn}',
  'ui.fastContext.trace.progressDetail': '已吸收 {absorbed}/{files} · {hits} 个命中{latest}',
  'ui.fastContext.trace.turnDetail': '{calls} 次调用 · {duration} · 输出 {tokens}',
  'ui.work.label': '工作',
  'ui.work.mainAgent': '主 Agent',
  'ui.activity.title': '活动',
  'ui.activity.summaryWorking': '{count} 项进行中',
  'ui.activity.summaryComplete': '{count} 项已完成',
  'ui.activity.summaryFailed': '{count} 项失败',
  ...
  'ui.flow.fastContextState': 'FastContext 正在{state}',
  'ui.flow.readyNext': '已准备接收下一项任务',
  'ui.flow.fcEvidence': 'FC {state} · {count} 份证据',
  'ui.flow.fcState': 'FC {state}',
  'ui.flow.fcEvidenceReady': 'FC 证据已就绪',
  'ui.flow.fcFailed': 'FC 失败',
  'ui.flow.fcCancelled': 'FC 已取消',
  ...
  'ui.flow.fcAssembling': '汇总',
  'ui.flow.fcRanking': '排序',
  'ui.flow.fcMapping': '映射',
  'ui.flow.fcReady': '就绪',
  'ui.flow.fcCancelledState': '已取消',
  'ui.flow.fcAttention': '等待处理',
  ...
  'ui.file.label': '文件',
  'ui.file.writing': '正在写入',
  'ui.file.replacing': '正在替换',
  'ui.file.editing': '正在编辑',
  'ui.file.applying': '正在应用编辑',
  'ui.file.deleting': '正在删除',
  'ui.file.preparingWrite': '准备写入',
  'ui.file.preparingReplace': '准备替换',
  'ui.file.preparingEdit': '准备编辑',
  'ui.file.preparingEdits': '准备批量编辑',
  'ui.file.preparingDelete': '准备删除',
  'ui.file.target': '{verb}文件',
  'ui.file.prepared': ' · 已准备 {size}',
  ...
  'ui.tool.running.explore': '正在探索 {target}',
